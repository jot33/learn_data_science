...
ode_options = odeset('RelTol',1e-11,'AbsTol',1e-11);

%% Problem 1a, A1

[t,A1] = ode45(@vdpe1, tspan, y0, ode_options);

%% Problem 1a, A2

[t,A2] = ode45(@vdpe2, tspan, y0, ode_options);

%% Problem 1a, A3

[t,A3] = ode45(@vdpe3, tspan, y0, ode_options);


%% Problem 1b, A4

[t1,A41] = ode45(@vdpe1, tspan(1:10/dt+1), y0, ode_options); % t1: [0,10]
[t2,A42] = ode45(@vdpe2, tspan(10/dt+1:20/dt+1), A41(end,:)', ...
    ode_options); % t2: [10,20]
[t3,A43] = ode45(@vdpe3, tspan(20/dt+1:end), A42(end,:)', ...
    ode_options); % t3: [20,30]
