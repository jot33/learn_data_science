...
[t1,A41] = ode45(@vdp, tspan(1:10/dt+1), y0, e=0.1); % t1: [0,10]
[t2,A42] = ode45(@vdp, tspan(10/dt+1:20/dt+1), A41(end,:)', e=1);%[10,20]
[t3,A43] = ode45(@vdp, tspan(20/dt+1:end), A42(end,:)', e=20); %[20,30]
...
function dydt = vdp(t,y,e)
    dydt = [y(2); e*(1-y(1)^2)*y(2)-y(1)];
end